...
curl -s https://raw.githubusercontent.com/FinnAppel/Pterodactyl-Unattended-Install/main/config/wings.service > /etc/systemd/system/wings.service
...
echo "* Please refer to the official guide: https://pterodactyl.io/wings/1.0/installing.html#configure"
echo "*"
